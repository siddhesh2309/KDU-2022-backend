package com.kd.assignment.readFiles;
...
public class ReadCoins {
    ...
    public static void readDataFromCoins(HashMap<String, Coin> coinNameAndCoinObject, HashMap<String, Coin> coinSymbolAndCoinObject) throws IOException {
